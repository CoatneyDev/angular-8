...
import { TermsComponent } from 'src/app/modules/legal/pages/terms/terms.component';
@Injectable({
  providedIn: 'root'
})
export class DynamicDataService {
  ...
  public getComponent(strType: string): Type<any> {
    if (strType === 'terms') {
      return this.getTermsComponent();
    }
  }

  public getTermsComponent() {
